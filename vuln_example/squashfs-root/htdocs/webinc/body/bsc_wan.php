...
<div class="blackbox" <?if ($FEATURE_NOAPMODE == "1") echo 'style="display:none;"';?> >
	<h2><?echo i18n("Access Point Mode");?></h2>
		...
		<div align="center" >
			<span><?echo i18n("NAT Enable/Disable");?></span>
			<span>:</span>
			<span><input type="radio" id="rtmode" name="Type" onclick="PAGE.OnClickRgmode('rtcheckbox');"><?echo i18n("Router Mode");?></span>
			<span><input type="radio" id="apmode" name="Type" onclick="PAGE.OnClickRgmode('apcheckbox');"><?echo i18n("AP Mode");?></span>
			<span><input type="radio" id="atmode" name="Type" onclick="PAGE.OnClickRgmode('atcheckbox');"><?echo i18n("Auto Mode");?></span>
		</div>	
	<div class="gap"></div>
</div>
<!-- wan mode -->
...
if ($FEATURE_NOSCH=="1")	echo '</span>\n';
	...
	<div id="box_wan_pptp_body" style="display:none">
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input id="pptp_server" type="text" size="20" maxlength="15" /></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Username");?></span>
			<span class="delimiter">:</span>
...
if ($FEATURE_NOSCH=="1")	echo '</span>\n';
	...
	<div id="box_wan_l2tp_body" style="display:none">
		...
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input id="l2tp_server" type="text" size="20" maxlength="15" /></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Username");?></span>
			<span class="delimiter">:</span>
