...
<div class="blackbox">
	...
	<div class="textinput">
		...
		<span class="value">
			...
			<option value="6IN4"><?echo i18n("IPv6 over IPv4 Tunnel");?></option>
...
-->
		<div class="textinput">
			...
			<span class="delimiter">:</span>
			<span class="value"><input id="ppp6_mtu" type="text" size="10" maxlength="4" /><?echo i18n("(bytes)");?></span>
		</div>
	</div>
	...
	<div id="box_wan_6rd_body" style="display:none">
		<div class="textinput">
			...
			<span class="value">
				...
				<input id="w_6rd_prefix_2" type="text" size="15" maxlength="39" />
			</span>
		</div>
		<div class="textinput">
			...
			:
			<!--<span class="delimiter">:</span>-->
			<input id="w_6rd_v4addr_mask" type="text" size="2" maxlength="2" /></span>	
		</div>
		<div class="textinput">
...
-->
		<div class="textinput">
			<span class="name"><?echo i18n("6rd Relay");?></span>
			<span class="delimiter">:</span>
			<span class="value"><input id="w_6rd_relay" type="text" size="42" maxlength="15" /></span></span>
		</div>
		<div class="textinput">
			<span class="name"><?echo i18n("Primary DNS Server");?></span>
			<span class="delimiter">:</span>
	...
	<div id="box_wan_tunnel" style="display:none">
		<h2><?echo i18n("IPv6 over IPv4 TUNNEL SETTINGS");?></h2>
		<p class="strong"><?echo i18n(" Enter the IPv6 over IPv4 Tunnel information provided by your Tunnel Broker.");?> </p>
	</div>
	...
	<div id="box_lan" style="display:none"> 
		<h2><?echo i18n("LAN IPv6 ADDRESS SETTINGS");?></h2>
			<p>
				...
				<span id="span_dsc1" style="display:none"><?echo i18n("If you change the LAN IPv6 Address here, you may need to adjust your PC's network settings to access the network again.");?></span>
	...
	<div id="box_lan_auto_body" style="display:none">  
		...
		<div class="textinput">
			...
			<span class="value">
				...
				<option value="STATELESS"><?echo i18n("Stateless");?></option>
         ...
         <div id="box_lan_dhcp" style="display:none">
                <div class="textinput">
			        ...
			        <input id="dhcps_start_ip_value" type="text" size="5" maxlength="4" />
		        ...
		        <div class="textinput">
			        ...
			        <input id="dhcps_stop_ip_value" type="text" size="5" maxlength="4" />
